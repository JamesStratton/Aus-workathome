...
assert level == "ind_health" if order == 5 
assert level == "ind_transp" if order == 6 
assert level == "ind_manuf" if order == 7 
...
assert level == "ind_media" if order == 14 
assert level == "ind_rent_hire_real_estate" if order == 15 
