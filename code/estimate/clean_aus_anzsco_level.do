...
* Get global for total employment 
sum Australia if Occupation == "Total Employed"
global aus_tot_emp = `r(mean)'
...
rename B anzsco_code 
rename C anzsco_description 
keep anzsco_code P-DR anzsco_description 

* Rename variables 
ds anzsco_code anzsco_description, not 
...
drop sa4_*97 sa4_*99 sa4_9*

* Save total employed 
tempfile data_before_drop 
save `data_before_drop' 
keep if anzsco_description == "Total Employed" 
xpose, clear varname 
rename v1 total_employed 
rename _varname level 
drop if mi(total_employed) 
save "${derived_data}/total_employed_sa4", replace 

* Save occupations 
use `data_before_drop', clear 
